...
@Entity
@Table(name = "wf_ref_to_type")
public class WfRefToType extends BaseEntity{

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "ref_to_type_id")
	private String refToTypeId;
	...
	public String getRefToTypeId() {
		return refToTypeId;
	}

	public void setRefToTypeId(String refToTypeId) {
		this.refToTypeId = refToTypeId;
	}
